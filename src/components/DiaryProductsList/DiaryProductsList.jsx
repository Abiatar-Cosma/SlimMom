...
import DiaryProductsItem from "../DiaryProductItem/DiaryProductItem";
import Loader from "../Loader/Loader";

import s from "./DiaryProductsList.module.css";

const DiaryProductsList = () => {
  const { dailyMeals, date, isLoading, error } = useSelector(
  ...
  return (
    <>
      ...
      {noMeals && (
        <p className={s.error}>You haven't added any meal this day.</p>
      )}
    </>
  );
};
